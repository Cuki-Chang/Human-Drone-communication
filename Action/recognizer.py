    ...
    if bboxes:
        ...
        for d in trk_result:
            ...
            if joints_norm_per_frame.size > 0:
                ...
                # 显示动作类别
                cv.putText(frame, init_label, (xmin + 80, ymin - 45), cv.FONT_HERSHEY_SIMPLEX, 1, trk_clr, 3)
                if init_label == 'attention':
                    cv.putText(frame , 'he/she may need help!', (20, 90), cv.FONT_HERSHEY_SIMPLEX, 1,
                               (0, 0, 255), 2)
                if init_label == 'PhoneCall':
                    cv.putText(frame , 'Call the Emergence!', (20, 90), cv.FONT_HERSHEY_SIMPLEX, 1,
                               (0, 0, 255), 2)
